  ...
  return (
    <div className="flex flex-col shadow-md cursor-pointer hover:-translate-y-1 duration-300">
      ...
      <div className="flex flex-row flex-auto justify-end">
        <a className="flex text-xs border px-3 my-auto py-2 mr-2 bg-dark-button group rounded-sm transition-all duration-200">
          <FaCartShopping className="size-4" />
        </a>

        <a className="flex text-xs border px-3 my-auto py-2 bg-dark-button group rounded-sm transition-all duration-200">
          <FaEye className="size-4" />
          <div className="text-xs font-semibold ml-2 group delay-100">
            Live Preview
          </div>
        </a>
      </div>
